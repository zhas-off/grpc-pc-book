...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=grpcpcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x6f, 0x6b, 0x22, 0x99, 0x02, 0x0a, 0x06, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x12, 0x1b, 0x0a,
	...
	0x2e, 0x67, 0x72, 0x70, 0x63, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x63, 0x72, 0x65,
	...
	0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x70,
	0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x2e, 0x50, 0x61, 0x6e,
	...
	0x50, 0x53, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x23,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: grpcpcbook.Screen.Panel
	(*Screen)(nil),            // 1: grpcpcbook.Screen
	(*Screen_Resolution)(nil), // 2: grpcpcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: grpcpcbook.Screen.resolution:type_name -> grpcpcbook.Screen.Resolution
	0, // 1: grpcpcbook.Screen.panel:type_name -> grpcpcbook.Screen.Panel
