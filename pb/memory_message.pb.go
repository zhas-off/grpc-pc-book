...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=grpcpcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x6f, 0x6b, 0x22, 0xab, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x12, 0x14, 0x0a,
	...
	0x0e, 0x32, 0x17, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d,
	...
	0x42, 0x23, 0x0a, 0x19, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x67,
	0x72, 0x70, 0x63, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x70, 0x62, 0x50, 0x01, 0x5a,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: grpcpcbook.Memory.Unit
	(*Memory)(nil),   // 1: grpcpcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: grpcpcbook.Memory.unit:type_name -> grpcpcbook.Memory.Unit
