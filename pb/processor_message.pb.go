...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x67, 0x72, 0x70, 0x63, 0x70,
	...
	0x67, 0x72, 0x70, 0x63, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72,
	0x79, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x42, 0x23, 0x0a, 0x19, 0x63, 0x6f, 0x6d,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: grpcpcbook.CPU
	(*GPU)(nil),    // 1: grpcpcbook.GPU
	(*Memory)(nil), // 2: grpcpcbook.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: grpcpcbook.GPU.memory:type_name -> grpcpcbook.Memory
