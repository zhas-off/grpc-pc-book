...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=grpcpcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x67, 0x72, 0x70, 0x63, 0x70, 0x63, 0x62,
	...
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x70, 0x63, 0x62, 0x6f,
	...
	0x48, 0x44, 0x44, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x53, 0x53, 0x44, 0x10, 0x02, 0x42, 0x23,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: grpcpcbook.Storage.Driver
	(*Storage)(nil),     // 1: grpcpcbook.Storage
	(*Memory)(nil),      // 2: grpcpcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: grpcpcbook.Storage.driver:type_name -> grpcpcbook.Storage.Driver
	2, // 1: grpcpcbook.Storage.memory:type_name -> grpcpcbook.Memory
